...
/*   Updated: 2024/10/17 13:58:26 by jeperez-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
Estructura para hacer listas de datos.
- content: la información contenida por el nodo.
- next: la dirección del siguiente nodo, o NULL
	si el siguiente nodo es el último.*/
typedef struct s_list
{
	/* pointer to the content of the node. */
	void			*content;
	/* pointer to the next node on the list. \0 if it's the last one. */
	struct s_list	*next;
}					t_list;
